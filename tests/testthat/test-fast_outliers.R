...
test_df_1 = tibble::tibble("col_A"= c(1,2,1,2,3,3,1,2,4,3,1,2,1,2,3,3,1,2,4,3,1,2,1,2,3,3,1,2,4,3,1,2,1,2,3,3,1,2,4,3), 
                 "col_B"=c("A", "A", "A", "A","A","A","A","A","A","A","B", "B", "B", "B","B","B","B","B","B","B","C", "C", "C", "C","C","C","C","C","C","C","D", "D", "D", "D","D","D","D","D","D","D"),
                 "col_C"=c(8.1, 10.6, 8.9,7.9 ,9.9 ,7.9,10.1,9.5,8.7,8.5,8.1, 10.6, 8.9,7.9 ,9.9 ,7.1,10.1,9.5,8.7,8.5,8.1, 10.6, 8.9,7.9 ,9.9 ,7.1,10.1,9.5,8.7,8.5,8.1, 10.6, 8.9,7.9 ,9.9 ,7.1,10.1,9.5,8.7,8.5)
)
test_df_2 = tibble::tibble("col_A"= c(1000,1000,NaN,2,3,3,1,2,4,5,1,2,1,2,3,3,1,2,4,5,1,2,1,2,3,3,1,2,4,5,1,2,1,2,3,3,1,2,4,5), 
